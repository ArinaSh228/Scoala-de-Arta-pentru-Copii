const professors = [ /*Масив*/
  ...
  },
  {
    ...
    position: "Учитель",
    experience: "Стаж 15+ лет",
    description: "Л. Ананией – выпускница Академии искусств Молдовы, а также Национального университета искусств в Бухаресте. Её профессионализм, креативность и преданность искусству помогают его ученикам раскрыть свой потенциал, улучшить технику и найти уникальные способы самовыражения.",
...
renderProfessors(); /*создает карточки для каждого преподавателя из массива professors*/

function myFunction() { /* управляет элементами с id="dots" и id="more"*/
...
document.addEventListener('DOMContentLoaded', function () { /*Чтобы убедиться, что весь HTML загружен перед выполнением кода*/
